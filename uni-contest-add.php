            ...
            <ul class='wraplist'>
                ...
                <li class="open">
                    ...
                    <ul class="sub-menu" style='display:block;'>
                        ...
                        <li>
                            <a class="active" href="uni-contest-add.php">Add Contest</a>
                        </li>
                        <!--                        <li>-->
        ...
        <section class="wrapper main-wrapper" style=''>
            <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                <div class="page-title">
                    ...
                    <div class="float-left">
                        <h1 class="title">Add a Contest</h1>
                    </div>
                    ...
                    <div class="float-right d-none">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="uni-contests.php">Contents</a>
                            </li>
                            <li class="active">
            ...
            <div class="col-xl-12 col-lg-12 col-12 col-md-12">
                <section class="box ">
                    ...
                    <div class="content-body">
                        <div class="row">
                            <form action="uni-contest-addsave.php" method="post">
                                <div class="col-xl-8 col-lg-8 col-md-9 col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="field-1">Contest Name</label>
                                        <span class="desc"></span>
                                        <div class="controls">
                                            <input type="text" value="Contest" class="form-control" id="field-1"
                                                   name="name" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control datepicker"
                                                           data-format="yyyy-mm-dd" name="startDate" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control datepicker"
                                                           data-format="yyyy-mm-dd" value="" name="startPickingDate"
                                                           required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="time" class="form-control" name="startPickingTime"
                                                           required>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control datepicker"
                                                           data-format="yyyy-mm-dd" name="endDate" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control datepicker"
                                                           data-format="yyyy-mm-dd" name="endPickingDate" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <span class="desc"></span>
                                                <div class="controls">
                                                    <input type="time" class="form-control" name="endPickingTime"
                                                           required>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="desc"></span>
                                        <div class="controls">
                                            <input type="number" class="form-control" name="maxContestants" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="desc"></span>
                                        <div class="controls">
                                            <input type="text" class="form-control" id="field-1" name="prizePot">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="desc"></span>
                                        <div class="controls">
                                            <input type="text" class="form-control" id="field-1" name="entryFees">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="desc"></span>
                                        <div class="controls">
                                            <input type="text" class="form-control" id="field-1" name="bannerText">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea class="form-control" rows="10" id="field-6"
                                                      name="rules"></textarea>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputEmail3" name="amountOne"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">2 nd</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputEmail3" name="amountTwo"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">3 rd</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputEmail3" name="amountThree"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">4 th</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputEmail3" name="amountFour"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">5 th</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputEmail3" name="amountFive"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">6 th</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputEmail3" name="amountSix"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">7 th</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputEmail3" name="amountSeven"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">8 th</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputEmail3" name="amountEight"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">9 th</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputEmail3" name="amountNine"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">10 th</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" id="inputEmail3" name="amountTen"/>
                                        </div>
                                    </div>
