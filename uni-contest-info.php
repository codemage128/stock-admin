...
curl_close($ch);
$result = json_decode($excute);
$contestDetail = $result->data->contestDetail;
...
$stockAddStartDateTime = $contestDetail->stockAddStartDateTime;
$stockAddEndDateTime = $contestDetail->stockAddEndDateTime;
$startDateTime = $contestDetail->startDateTime;
$endDateTime = $contestDetail->endDateTime;
$maxContestants = $contestDetail->maxContestants;
$prizePot = $contestDetail->prizePot;
$entryFees = $contestDetail->entryFees;
$bannerText = $contestDetail->bannerText;
$rules = $contestDetail->rules;
$activeStatus = $contestDetail->activeStatus;
$resetStatus = $contestDetail->resetStatus;
            ...
            <ul class='wraplist'>
                ...
                <li class="open">
                    ...
                    <ul class="sub-menu" style='display:block;'>
                        ...
                        <!--                                </li>-->
                        <!-- <li>
                            <a class="active" href="uni-contest-info.php" >Contest Info</a>
                        </li> -->
                    </ul>
                </li>
            </ul>
        ...
        <section class="wrapper main-wrapper" style=''>
            ...
            <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                <div class="page-title">
                    ...
                    <div class="float-left">
                        <h1 class="title">Contest Info</h1></div>
                    ...
                    <div class="float-right d-none">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="uni-courses.php">Contents</a>
                            </li>
                            <li class="active">
                                <strong>Contest Info</strong>
                            </li>
                        </ol>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <div class="uprofile-image">
                                    <img src="data/courses/course-1.jpg" class="img-fluid">
                                </div>
                            ...
                            <div class="col-md-9 col-sm-8 col-xs-12">
                                ...
                                <div class="uprofile-content">
                                    ...
                                    <div class="">
                                        ...
                                        <p>Stock picking start date time: <?php echo $stockAddStartDateTime ?></p>
                                        <p>Stock picking end date time: <?php echo $stockAddEndDateTime ?></p>
                                        <p>Start date time: <?php echo $startDateTime ?></p>
                                        <p>End date time: <?php echo $endDateTime ?></p>
                                        <p>Max contestants: <?php echo $maxContestants ?></p>
                                        <p>Prize pot: <?php echo $prizePot ?></p>
                                        <p>Entry fees: <?php echo $entryFees ?></p>
                                        <p>Banner Text: <?php echo $bannerText ?></p>
                                        <p>Rules: <?php echo $rules ?></p>
                                        <p>Active Status: <?php echo $activeStatus ?></p>
                                        <p>Reset Status: <?php echo $resetStatus ?></p>
                                        <h4>Prizes</h4>
                                        <ul>
                                            <li>1 st  : <?php echo $amountOne?></li>
                                            <li>2 nd  : <?php echo $amountTwo?></li>
                                            <li>3 th  : <?php echo $amountThree?></li>
                                            <li>4 th  : <?php echo $amountFour?></li>
                                            <li>5 th  : <?php echo $amountFive?></li>
                                            <li>6 th  : <?php echo $amountSix?></li>
                                            <li>7 th  : <?php echo $amountSeven?></li>
                                            <li>8 th  : <?php echo $amountEight?></li>
                                            <li>9 th  : <?php echo $amountNine?></li>
                                            <li>10 th : <?php echo $amountTen?></li>
                                        </ul>
                                        <div class="clearfix"></div>
                                        <hr>
                                        <div class="clearfix"></div>
