...
<!--                        </li>-->
                ...
                <li class="open">
                    ...
                    <ul class="sub-menu" style='display:block;'>
                        <li>
                            <a class="active" href="uni-contests.php">All Contests</a>
                        </li>
                        <li>
                ...
                <div class="page-title">
                    ...
                    <div class="float-right d-none">
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="uni-contests.php">Contests</a>
                            </li>
                            <li class="active">
            ...
            <div class="col-lg-12">
                <section class="box ">
                    <header class="panel_header">
                        <h2 class="title float-left">All Contests</h2>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    ...
                                    // get user part.
                                    $api_url = "https://jarbly.com/stockApp/stockAd/Admin/getAllContests";
                                    $ch = curl_init();
                                        ...
                                        <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                            <div class="team-member ">
                                                <div class="row margin-0">
                                                    <div class="team-img ">
                                                        <img class="img-fluid" src="data/courses/course-1.jpg" alt="">
                                                    </div>
                                                    <div class="team-info">
                                                        <h4>
                                                            <a href="uni-contest-info.php?contestId=<?php echo $contest->id ?>">
                                                                <?php echo($contest->name) ?></a>
                                                        </h4>
                                                        <span class='team-member-edit'><a href="uni-contest-edit.php?contestId=<?php echo $contest->id ?>"><i
