...
$api_url = "https://jarbly.com/stockApp/stockAd/Admin/userInfo";
$ch = curl_init();
            ...
            <ul class='wraplist'>
                ...
                <li class="open">
                    ...
                    <ul class="sub-menu" style='display:block;'>
                        ...
                        <!--                            <li>-->
                        <!--                                <a class="active" href="uni-user-edit.php">Edit User</a>-->
                        <!--                            </li>-->
                        <!-- <li>
                ...
                <li class="">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a class="" href="uni-contests.php">All Contents</a>
                        </li>
                        <li>
                            <a class="" href="uni-contest-add.php">Add Content</a>
                        </li>
                        <!--                            <li>-->
                        <!--                                <a class="" href="uni-contest-edit.php">Edit Content</a>-->
                        <!--                            </li>-->
                        <!-- <li>
                            <a class="" href="uni-contest-info.php">Content Info</a>
                        </li> -->
                    </ul>
                </li>
            </ul>
