            ...
            <ul class='wraplist'>
                ...
                <li class="open">
                    ...
                    <ul class="sub-menu" style='display:block;'>
                        <li>
                            <a class="active" href="uni-users.php">All Users</a>
                        </li>
                        <li>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    ...
                                    // get user part.
                                    $api_url = "https://jarbly.com/stockApp/stockAd/Admin/getAllUsers";
                                    $ch = curl_init();
                                        ...
                                        <div class="col-lg-3 col-sm-6 col-md-4 music_genre">
                                            <div class="team-member ">
                                                <div class="row margin-0">
                                                    ...
                                                    <div class="team-info">
                                                        <h4>
                                                            <a href="uni-user-profile.php?userId=<?php echo $user->id ?>">
                                                                <?php echo($user->userName) ?></a>
                                                        </h4>
                                                        <span class='team-member-edit'><a href="uni-user-edit.php?userId=<?php echo $user->id ?>"><i
